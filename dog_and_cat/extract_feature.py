...
ap.add_argument("-b", "--batchSize", default=16, help="Batch size")
...
print("[INFO] Loading model ResNet")
model = ResNet50(weights="imagenet", include_top=False)
dataset = HDF5DatasetWriter(dims=(len(imagePaths), 2048*7*7), outputPath=args["output"], dataKey="features", buffSize=args["bufferSize"])
